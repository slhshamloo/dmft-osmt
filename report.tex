...
% add figure for spectral function
...
Overall, our results are lower than those cited above. This might be agreement with theory, predicting that the critical $U$ at which transition occurs goes down as temperature is increased. %Really ? Source ? Actually this might have nothing to do with temperature

In contrast, Knecht et al. \cite{Knecht2004} find lower values in the $J_z$ model, with $U_{c1} \approx 2.1$ and $U_{c2} \approx 2.6$, contradicting Liebsch's finding of the absence of OSMT \cite{Liebsch2004}. %Add reference to 2nd Koga paper

% Insert discussion of the kink for Z2 at the first transition
...
The graph seems to be in agreement with Koga's results at $T = 0$ for the same model, where there is a single transition at $U_c = 7.3$.
% Insert graph of Z for J = 0
